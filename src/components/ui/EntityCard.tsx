...
import { Eye, Pencil, MoreHorizontal, Trash2, Check } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function EntityCard({
  ...
  return (
    <>
      <div className="bg-card rounded-2xl border border-border flex flex-col hover:shadow-lg hover:shadow-foreground/5 transition-all overflow-hidden">
        {/* Card body */}
