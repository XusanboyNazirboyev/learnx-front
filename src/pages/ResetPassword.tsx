...
import { GraduationCap, Loader2, KeyRound, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          <h1 className="font-heading font-bold text-2xl">Yangi parol o'rnatish</h1>
          <p className="mt-2 text-sm text-muted-foreground">SMS yoki emailga kelgan kodni kiriting va yangi parol belgilang.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <a href="/forgot-password" className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
