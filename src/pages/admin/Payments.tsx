...
type PaymentResponse = { items: Payment[]; totalAmount: number | string; meta: { total: number } };

export default function Payments() {
  const [response, setResponse] = useState<PaymentResponse>({ items: [], totalAmount: 0, meta: { total: 0 } });
